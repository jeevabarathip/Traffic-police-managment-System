...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			</figure><h><b>TRAFFIC  POLICE</b></h>
			<h1 class="animated fadeInDown delay-07s">WELCOME TO  TRAFFIC CONTROL</h1>
			<ul class="we-create animated fadeInUp delay-1s">
				<li>IFollow traffic rules, <b> save your future</b></li>
			</ul>
	...
	<nav class="main-nav-outer" id="test">
		...
		<div class="container">
			<ul class="main-nav">
				...
				<li class="small-logo"><a href="#header"><img src="img/govlogo.png" height="70" width="70" alt=""></a></li>
