...
<html>
 <head>
	...
	<link rel="icon" href="img/govlogo.png" type="image/png">
	<link rel="shortcut icon" href="img/govlogo.png" type="img/x-icon">
	...
	<header class="header" id="header">
		...
		<div class="container">
			<figure class="logo animated fadeInDown delay-07s">
				<a href="#"><img src="img/govlogo.png" alt=""></a>
			</figure>
			<h2 style="color: white;"><b>TRAFFIC  POLICE</b></h2>
            ...
            <div class="row mt-5">
                ...
                <form method="" id="signup-form" class="signup-form">
                    ...
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Drunk and Drive</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="5000" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Without license</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="5000" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Over load</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="5000" cname='Challan name' />
                    </div>
                    <div class="form-group mt-4">
                      <label  class="mr-5"><span><h3 class="text-white">Helmet</h3></span>
                      </label>
                      <input type="checkbox" class="ctype" name="vname" value="5000" cname='Challan name' />
                    </div>
